...
This is the working bibliography / doc set for the Unitree G1 whole-body control project in **INSI** (Institute for Intelligent Networked Systems Laboratory; Professor Yanzhi Wang).
...
Small **INSI** team (student + physicist collaborator + advisor). Keep the first paper contribution **control-centric**; use VLA repos as optional upstream brains, not the critical path for week 1–4.
